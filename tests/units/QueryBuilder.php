...
class QueryBuilder extends atoum {
    ...
    public function testInsertQueryWithOneField(\PicORM\QueryBuilder $insertQueryBuilder) {
        $insertQueryBuilder -> insertInto("tableName") -> values("tableField","1");
        $resultQuery = "INSERT INTO tableName (tableField) VALUES (1)";
        $this -> variable($insertQueryBuilder -> buildQuery()) -> isEqualTo($resultQuery);
    }
    ...
    public function testInsertQueryWithTwoFields(\PicORM\QueryBuilder $insertQueryBuilder) {
        $insertQueryBuilder -> insertInto("tableName") -> values("tableField","1")-> values("tableField2","'foobar'");
    ...
    public function testBuildUpdateQuery(\PicORM\QueryBuilder $updateQueryBuilder) {
        $updateQueryBuilder -> update('tableName t') -> set('tableField','3') -> set('tableField2','5');
        $setParams = "SET tableField = 3,tableField2 = 5";
        $resultQuery = 'UPDATE tableName t  ';
        $this -> variable($updateQueryBuilder -> buildQuery()) -> isEqualTo($resultQuery.$setParams);
        ...
        $this -> variable($updateQueryBuilder -> buildQuery()) -> isEqualTo($resultQuery);
        ...
        $this -> variable($updateQueryBuilder -> buildQuery()) -> isEqualTo($resultQuery.' LIMIT 10');
    ...
    public function testBuildDeleteQuery(\PicORM\QueryBuilder $deleteQueryBuilder) {
        ...
        $this -> variable($deleteQueryBuilder -> buildQuery()) -> isEqualTo($resultQuery);
        ...
        $this -> variable($deleteQueryBuilder -> buildQuery()) -> isEqualTo($resultQuery.' LIMIT 10');
    ...
    public function testBuildSelectQuery(\PicORM\QueryBuilder $selectQueryBuilder)
    {
        ...
        $this -> variable($selectQueryBuilder -> buildQuery()) -> isEqualTo($resultQuery);
        ...
        $this -> variable($selectQueryBuilder -> buildQuery()) -> isEqualTo($resultQuery.' LIMIT 10');
